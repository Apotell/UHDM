...
def generate(models):
    ...
    any_defs = [
      (f'      .def("enter{ClassName}", &uhdm::UhdmListener::enter{ClassName})\n'
       f'      .def("leave{ClassName}", &uhdm::UhdmListener::leave{ClassName})\n')
      for ClassName in ClassNames
    ]
    many_defs = [
      (f'      .def("enter{TypeName}Collection", &uhdm::UhdmListener::enter{TypeName}Collection)\n'
       f'      .def("leave{TypeName}Collection", &uhdm::UhdmListener::leave{TypeName}Collection)\n')
      for TypeName in TypeNames
    ]
