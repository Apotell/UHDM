...
def _main():
    ...
    params = [
        ...
        ('Copier', [{
            ...
            config.get_template_filepath('Reducer.h'): config.get_output_header_filepath('Reducer.h'),
            config.get_template_filepath('Reducer.cpp'): config.get_output_source_filepath('Reducer.cpp'),
