...
def generate(models):
    ...
    any_defs = [f'      .def("visit_{ClassName}", &uhdm::UhdmVisitor::visit{ClassName})' for ClassName in ClassNames]
    many_defs = [f'      .def("visit_{TypeName}Collection", &uhdm::UhdmVisitor::visit{TypeName}Collection)' for TypeName in TypeNames]
